    ...
    if (dt_user_table.length) {
        var dt_user = dt_user_table.DataTable({
            ...
            columnDefs: [
                ...
                {
                    targets: 4, // Participants column
                    render: function (data, type, row) {
                        return data.length;
                    }
                },
                {
                    targets: 5, // Completions column
                    render: function (data, type, row) {
                        return data.length;
                    }
                },

                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            `<a href="survey/update?surveyId=${full["Id"]}" class="dropdown-item"><i class="mdi mdi-pencil-outline me-2"></i><span>Edit</span></a>` +
            ...
            buttons: [
                ...
                {
                    text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Create Survey</span>',
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response === "Survey deleted successfully") {
                    ...
                    alert("No survey found with the provided ID");
                } else {
